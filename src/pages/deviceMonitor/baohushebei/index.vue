<template>
  <div>
    <topHeader equType="2" anaType="SheBei-BaoHuSheBei" @change="handleTopChange" @topInfoSelect="topInfoSelect">
    </topHeader>
    <div :class="{ flex_row: $isPc, flex_column: !$isPc }">
      <deviceInfo deviceName="保护设备" runningStatus="0" communicateStatus="0" :deviceInfoList="equipAttr"
