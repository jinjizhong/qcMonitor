<template>
  <div>
    <topHeader equType="2" anaType="SheBei-BiLeiQi" @change="handleTopChange" @topInfoSelect="topInfoSelect">
    </topHeader>
    <div :class="{ flex_row: $isPc, flex_column: !$isPc }">
      <deviceInfo deviceName="避雷器" runningStatus="0" communicateStatus="0" :deviceInfoList="equipAttr"
        ...
        <div class="right-bottom">
          ...
          <div class="flex bottom-mar">
            ...
            <div v-if="$isPc" class="flex" style="padding-left: 2%;width: 45%;">
              ...
              <el-date-picker class="time2" v-model="startTime" type="date" :clearable="false" placeholder="选择日期"
                @change="handleDate" />
