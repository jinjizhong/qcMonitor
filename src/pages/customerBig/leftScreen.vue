    ...
    <div>
      ...
      <div class="left-content charts_inset_shadow">
        <div style="height: 289px;width: 334px;">
          <barCharts title="当月负荷" barWidth="334" barHeight="289" :dataList="todayElectLoad.y"
            :xName="todayElectLoad.x.data" unitL="(MW)" unit="(日)" :gridPos="todayElectLoad.grid"
        ...
        <div style="height: 289px;width: 334px;">
          ...
          <barCharts title="周总用电量" barWidth="334" barHeight="289" unitL="(万kWh)" unit="(日)" :dataList="totalElecUsed.y"
        ...
        <p class="line-column" />
        <div style="height: 289px;width: 334px;">
          <barCharts unitL="(万kWh)" unit="(月)" barWidth="334" barHeight="289" title="月发电量与上网电量"
    ...
    <div>
      <div class="charts_inset_shadow mid-content-top">
        ...
        <div class="flex mid-banner-mar">
          ...
          <div class="mid-right">
            ...
            <div class="f-center" style="margin-top: 66px;">
              <warterCharts warterWidth="82" warterHeight="82" bgcolor="#04061d" :font="font" shadowBlur="0"
        ...
        <div class="f-between">
          <div style="height: 280px;width: 401px;">
            <barCharts unitL="(kW)" unit="(日)" barWidth="404" barHeight="280" title="当月用电量" :dataList="monthData.y"
              :xName="monthData.x" :gridPos="monthData.grid" fontChartsColor="#9ACBEA" lineChartsColor="#0D3B6D"
              :isBorder="false" />
            <!-- <lineCharts barWidth="404" barHeight="280" title='当月用电量' :bool="true" :hasShadow="true" :dataConfig="useElected" /> -->
          </div>
          <p class="line-row" />
          <div style="height: 280px;width: 401px;">
            <!-- 不规则的山峰图 -->
      ...
      <div class="charts_inset_shadow mid-content-bottom f-between">
        <div style="height: 275px;width: 404px;">
          <barCharts unitL="(MW)" unit="(日)" barWidth="404" barHeight="275" title="发电功率" :dataList="createElecPower.y"
      ...
      <div class="right-content charts_inset_shadow r-top">
        ...
        <div class="flex">
          ...
          <div>
            ...
            <barCharts barWidth="390" barHeight="280" unitL="(个)" unit="(日)" :dataList="policySolve.y"
      ...
      <div class="right-content charts_inset_shadow r-middle">
        ...
        <div class="flex">
          ...
          <div>
            ...
            <barCharts barWidth="390" barHeight="280" unitL="(个)" unit="(日)" :dataList="orderSolve.y"
