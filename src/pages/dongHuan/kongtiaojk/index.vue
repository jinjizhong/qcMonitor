<template>
  <div>
    <topHeader equType="2" anaType="DongHaun-KongTiao" @change="handleTopChange" @topInfoSelect="topInfoSelect"></topHeader>
    <div :class="{ flex_row: $isPc, flex_column: !$isPc }">
      <deviceInfo deviceName="空调" runningStatus="0" communicateStatus="0" :deviceInfoList="equipAttr" @warnDataBtn="warnDataBtn"></deviceInfo>
