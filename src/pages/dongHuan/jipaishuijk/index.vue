<template>
  <div>
    <topHeader equType="2" anaType="DongHaun-JiPaiShui" @change="handleTopChange" @topInfoSelect="topInfoSelect"></topHeader>
    <div :class="{ flex_row: $isPc, flex_column: !$isPc }">
      <deviceInfo deviceName="给排水" runningStatus="0" communicateStatus="0" :deviceInfoList="equipAttr" @warnDataBtn="warnDataBtn"></deviceInfo>
