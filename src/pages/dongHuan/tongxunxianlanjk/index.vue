<template>
  <div>
    <topHeader equType="2" anaType="DongHaun-TongXunXianLan" @change="handleTopChange" @topInfoSelect="topInfoSelect"></topHeader>
    <div :class="{ flex_row: $isPc, flex_column: !$isPc }">
      <deviceInfo deviceName="通讯线缆" runningStatus="0" communicateStatus="0" :deviceInfoList="equipAttr" @warnDataBtn="warnDataBtn"></deviceInfo>
  ...
  methods: {
    ...
    loadData () {
      ...
      let data = {
        siteFid,
        equFid,
        anaType: 'DongHaun-TongXunXianLan',
